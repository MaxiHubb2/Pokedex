        ...
        <div class="container-fluid">
            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
                ...
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel"> <a class="navbar-brand poke-text"><img
                                src="../assets\img\logo\logo.png" width="50" height="50">
                            Pokedex</a></h5>
                ...
                <div class="offcanvas-body">
                    <div class="row botonera-sidebar">
                        <div class="col-md-6">
                            <a class="btn btn-warning mb-3 w-100" aria-current="page" href="busqueda.php">Volver a Pokedex</a>
                        </div>
                        <div class="col-md-6">
...
<?php
    echo '<div class="container mt-5 pt-5">
                <div class="card">
                    <div class="row">
                        <div class="col-lg-6">
                            <span class="pokemon-id">' . $_pokemon->identificador . '</span>
                            <div class="d-flex justify-content-center">
                                <img src="../uploads/' . $_pokemon->img . '" class="card-img-top pokemon-img" alt="' . $_pokemon->nombre . '">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card-body border-top">
                                <h1 class="card-title">'. $_pokemon->nombre . '</h1>
                                <div class="row" >
                                    <div class="col-3"> 
                                        <img class="w-100" src="../assets/img/vida.png">
                                        <p class="text-center" >'. $_pokemon->vida .'</p>
                                    </div>
                                    <div class="col-3"> 
                                        <img class="w-100" src="../assets/img/tipo/' . $_pokemon->tipo . '.png">
                                        <p class="text-center" >Tipo </p>
                                    </div>
                                    <div class="col-3">
                                        <img class="w-100" src="../assets/img/ataque.png">
                                        <p class="text-center" >'. $_pokemon->ataque .'</p>
                                    </div>
                                    <div class="col-3"> 
                                        <img class="w-100" src="../assets/img/velocidad.png">
                                        <p class="text-center" >'. $_pokemon->velocidad .'</p>
                                    </div>
                                    <p>'.$_pokemon->descripcion.'</p>
                                    <h4 class="border-top pt-3">Sobre el tipo</h4>
                                    <p>'.$_pokemon->tipoDesc.'</p>
                                </div>
                            </div>
                        </div>
                    </div>
